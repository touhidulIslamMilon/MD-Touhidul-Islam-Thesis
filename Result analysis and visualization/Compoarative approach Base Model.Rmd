---
title: "Comparative Approach: Base Model Implementation"
date: "November 2024"
...
library(zoo)      # For time series smoothing and analysis
...
# Import Base Model results

```{r}
# Set model parameters
epoch <- 2
model_name = " PANAS_X"  # Positive and Negative Affect Schedule - Expanded
# Use direct filename instead of generating it
#filename<-getfilename(epoch, query_type,similarity)
filename <- "Result/newpanx_mean.xlsx"  # File containing PANAS-X results
