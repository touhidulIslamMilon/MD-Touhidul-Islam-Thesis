...
def main():
    ...
    results_single.to_csv(f"ten/withsim/Single/newsimweathersingle_query_epoch{epoch_num}.csv")
    
    results_average = get_average(result_list, 'average')
    results_average.to_csv(f"ten/withsim/Mean/newsimweatherMulti_mean_query_epoch{epoch_num}.csv")
    results_median = get_average(result_list, 'median')
    results_median.to_csv(f"ten/withsim/Median/newsimweatherMulti_median_query_epoch{epoch_num}.csv")
