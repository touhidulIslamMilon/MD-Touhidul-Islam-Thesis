...
Description: Fine-tuning BERT model for Twitter data (2021 Q2)
"""
...
os.environ['TRANSFORMERS_CACHE'] = '/pfs/work7/workspace/scratch/ma_mislam-md_Islam_thesis/ma_mislam-mislam_twitterlm_thesis/cache'
...
batch_size = 64
wwm_probability = 0.2
file_path="/pfs/work7/workspace/scratch/ma_mislam-md_Islam_thesis/ma_mislam-mislam_twitterlm_thesis"
test_dateset=load_dataset('text', data_files = [file_path+"/Code/files/2023_11/2023_11_tweet_text"])
...
results = {}
size_list=[]
for i in range(30, 31): # change tzhe number here
    if i < 10:
        if i == 1:
    ...
    filename = file_path+"/Code/files/"+Week+"/"+Week+"_tweet_text"   
